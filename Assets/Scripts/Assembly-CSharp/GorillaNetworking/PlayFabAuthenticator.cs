...
namespace GorillaNetworking
{
	public class PlayFabAuthenticator : MonoBehaviour
	{
		...
		public void Awake()
		{
			PhotonNetwork.PhotonServerSettings.AppSettings.AppIdRealtime = "20f2bb30-8dea-4336-b8c8-bb3c463980c7";
			PhotonNetwork.PhotonServerSettings.AppSettings.AppIdVoice = "d55dfc64-5535-4f30-b052-34d023bfb634";
			PhotonNetwork.PhotonServerSettings.AppSettings.AppVersion = "live1110";
			PlayFabSettings.TitleId = "14AA75";
			if (instance == null)
			{
				instance = this;
			}
			...
			PlayFabHttp.SimplePostCall("https://.14AA75.playfabapi.com/", payload, delegate
			{
			}, delegate
			{
			});
